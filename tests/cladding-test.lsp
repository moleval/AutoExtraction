...
;;; РЕДАКЦИЯ 7: удалены временная c:reload (К4 выполнен)
;;; и зонды TBLTEST/TBLTEST2 (задача закрыта)
;;
;;; Команды:
...
(princ "\nCLADDING-TEST.LSP загружен (ред. 7).")
(princ "\nКоманды: MKTEST, RMTEST, CLCOUNTERS, TEST-FALLBACK")
(princ)