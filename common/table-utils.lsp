...
;; ============================================================
;; LEGACY — жадная упаковка групп целиком
;; НЕ является эталоном кускования проекта.
;; Эталон — tc-partition-flat (см. выше в этом файле).
;; Оставлен до аудита потребителей (возможно, только Фасонка).
;; После миграции Фасонки на tc-partition-flat — удалить.
;; ============================================================
;; ------------------------------------------------------------
;; tu-pack-groups
