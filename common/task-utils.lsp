...
;; tu-undo-cancel — закрыть и сразу откатить командой UNDO.
;;   ВНИМАНИЕ: метода vla-Undo в ActiveX Document НЕТ; cancel вызывает
;;   команду UNDO, поэтому его нельзя использовать внутри *error* —
