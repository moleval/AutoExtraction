...
;;
;;; ÈÑÏÐÀÂËÅÍÈß (àóäèò Ýòàï 4.2):
;;;   D4: Îïòèìèçàöèÿ ôóíêöèè extraction-unique-ci —
;;;       append çàìåí¸í íà cons/reverse (O(N?) ? O(N))
;;; ============================================================
...
;; ============================================================
;; ÓÍÈÊÀËÜÍÛÅ ÑÒÐÎÊÈ
;; ÈÑÏÐÀÂËÅÍÎ (àóäèò Ýòàï 4.2, ïóíêò D4):
;; Îïòèìèçèðîâàíî: cons âìåñòî append (O(1) âìåñòî O(N))
;; Ïîðÿäîê ýëåìåíòîâ ñîõðàíÿåòñÿ ÷åðåç reverse â êîíöå.
;; ============================================================
